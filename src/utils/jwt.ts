...
const accessTokenExpiresIn: number = process.env.ACCESS_TOKEN_EXPIRES ? parseInt(process.env.ACCESS_TOKEN_EXPIRES) : 15 * 60 * 1000;
const refreshTokenExpiresIn: number = process.env.REFRESH_TOKEN_EXPIRES ? parseInt(process.env.REFRESH_TOKEN_EXPIRES) : 7 * 24 * 60 * 60 * 1000;
